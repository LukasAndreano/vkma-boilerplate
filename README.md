...
В группах присутствует главный экран - _base.ts_ и другие дополнительные: _anyScreenName.ts_.
...
Названия таких компонентов должно начинаться с маленькой буквы. Например: usersStatistic.st.
